...
python3 generate_bn_vecs.py --file_in $MODEL_DIR/vgg_bn_dense_1_a_b.csv --file_out $MODEL_DIR/bnd1.sv --bn_id d1 --rshift $BN_PREC --bw_in 16 --bw_out 16
python3 generate_dense_vecs.py --file_in $MODEL_DIR/vgg_dense_1.csv --file_out $MODEL_DIR/dense_1.sv --lyr 1 --bw_w 2 --tput 2
python3 generate_bn_vecs.py --file_in $MODEL_DIR/vgg_bn_dense_2_a_b.csv --file_out $MODEL_DIR/bnd2.sv --bn_id d2 --rshift $BN_PREC --bw_in 16 --bw_out 16
python3 generate_dense_vecs.py --file_in $MODEL_DIR/vgg_dense_2.csv --file_out $MODEL_DIR/dense_2.sv --lyr 2 --bw_w 2
python3 generate_dense_vecs.py --file_in $MODEL_DIR/vgg_dense_3.csv --file_out $MODEL_DIR/dense_3.sv --lyr 3 --rshift $PREC --bw_w 16 --bw_w 16
...
rsync -aP $MODEL_DIR/*_hex.sv ../verilog_test/tw_vgg_2iq_test.sv ../rt_amc_models/f128/sim/ #tuna:~/rt_amc_models/f128/sim/
rm $MODEL_DIR/*_hex.sv
rsync -aP $MODEL_DIR/*.sv ../verilog/*.sv --exclude tw_vgg.sv --exclude tw_vgg_2iq_bin.sv --exclude tw_vgg_2iq_incr.sv ../rt_amc_models/f128/srcs/ #tuna:~/rt_amc_models/f128/srcs/
