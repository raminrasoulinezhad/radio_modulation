...
rsync -aP $MODEL_DIR/*_hex.sv ../verilog_test/tw_vgg_2iq_test.sv ../rt_amc_models/rfsoc/sim/ #tuna:~/rt_amc_models/rfsoc/sim/
rm $MODEL_DIR/*_hex.sv
rsync -aP $MODEL_DIR/*.sv ../verilog/*.sv --exclude tw_vgg_2iq_bin.sv --exclude tw_vgg_2iq_incr.sv ../rt_amc_models/rfsoc/srcs/ #tuna:~/rt_amc_models/rfsoc/srcs/
