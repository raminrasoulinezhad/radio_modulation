...
MODEL_DIR=../models/vgg_twn_nu_1.2_0.7_bin_64
PREC=6
BN_PREC=8
SHIFT=$(( PREC + BN_PREC ))
...
python3 compute_vgg_with_csv.py --model_name $MODEL_DIR --twn_incr_act 6 --nu_conv 1.2 --nu_dense 0.7 --prec $PREC \
 --bn_p $BN_PREC --wr_files --no_filts 64,64,64,64,64,64,64,128,128,24 --remove_mean
...
rsync -aP $MODEL_DIR/*_hex.sv ../verilog_test/tw_vgg_2iq_bin_test.sv ../rt_amc_models/bin64/sim/ #tuna:~/rt_amc_models/bin64/sim/
rm $MODEL_DIR/*_hex.sv
rsync -aP $MODEL_DIR/*.sv ../verilog/*.sv --exclude tw_vgg.sv --exclude tw_vgg_2iq.sv ../rt_amc_models/bin64/srcs/ #tuna:~/rt_amc_models/bin64/srcs/
