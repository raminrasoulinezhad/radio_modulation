...
rsync -aP $MODEL_DIR/*_hex.sv ../verilog_test/tw_vgg_2iq_bin_test.sv ../rt_amc_models/bin128/sim/ #tuna:~/rt_amc_models/bin128/sim/
rm $MODEL_DIR/*_hex.sv
rsync -aP $MODEL_DIR/*.sv ../verilog/*.sv --exclude tw_vgg.sv --exclude tw_vgg_2iq.sv ../rt_amc_models/bin128/srcs/ #tuna:~/rt_amc_models/bin128/srcs/
